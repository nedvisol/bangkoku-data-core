...
module.exports = function DynamicData(appName) {
  ...
  this.generateId = function() {
    ...
    uuid.v4(null, buffer);
    return buffer.readUIntLE(0, 4).toString(31) +
      buffer.readUIntLE(4, 4).toString(31) +
      buffer.readUIntLE(8, 4).toString(31) +
      buffer.readUIntLE(12, 4).toString(31);
  ...
  this.put = function(id, classId, json, indexHint) {
    var that = this;

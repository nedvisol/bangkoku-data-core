  ...
  **/
  this.update = function(id, classId, json, options) {
    ...
    .then(function(response){
      //get clean updated value without internal attrs
      var updateData = {};
      _.each(json, function(value, key){
        if (key[0] !== '_') {
      ...
      var newItem = _.extend({}, oldValues, updateData);
      ...
      var idxPuts = this._generateIndexItems(id, classId, updateData, previewData, idxOptions, false);
